...
class ProfileField extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('varname', 'match', 'pattern' => '/^[A-Za-z_0-9]+$/u',
			      'message' => UserModule::t("Variable name may only consist of A-z, 0-9, underscores, and must begin with a letter.")),
			array('varname', 'unique',
			      'message' => UserModule::t("Field already exists.")),
